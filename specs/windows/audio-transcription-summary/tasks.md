...
- [x] 24. 録音停止時のセクション制御
  - [x] 24.1 録音停止時に入力・リアルタイムを折りたたみ、文字起こし・要約を展開する
    - _要件: 20.1_

- [x] 25. 録音中の追加UI無効化
  - [x] 25.1 録音中に入力ソース選択・ファイル分割時間選択を無効化する
    - _要件: 15.6_

- [x] 26. リアルタイム言語再判別ボタンの実装
  - [x] 26.1 言語自動判別モード時に緑色更新アイコンの再判別ボタンを表示する
    - FontIcon &#xE72C;、色 #16C60C
    - クリックでリアルタイムストリーミング再接続
    - Auto選択時は初期状態から表示
    - _要件: 21.1, 21.2, 21.3_
